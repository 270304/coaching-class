...
# ── HELPERS ───────────────────────────────────────
def G(html):
    """Render green-safe HTML inside a guaranteed dark wrapper."""
    st.markdown(
...
with content:
    ...
    if selected == "About Us":
        ...
        <div style="background:#1a1a1a;border:1px solid #2a2a2a;border-radius:12px;overflow:hidden;margin-bottom:1rem;">
            ...
            <div style="padding:1.5rem 1.8rem;">
                ...
                <div style="font-size:0.87rem;color:#999;line-height:1.9;margin-bottom:1.2rem;">
                ...
                <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:0.8rem;">
                    <div style="background:#111;border:1px solid #22c55e;border-radius:10px;padding:1rem;text-align:center;">
                        <div style="font-family:'Bebas Neue',sans-serif;font-size:2rem;color:#22c55e;">120+</div>
    ...
    # ════════════════════════════════════════════
        ...
        if not t:
            ...
            with c2: st.selectbox("Subject", t.get("subjects", []))
        ...
        if not t:
            ...
            for s in STUDENTS:
                ...
                <div style="background:#1a1a1a;border:1px solid #2a2a2a;border-radius:12px;
                            ...
                            display:flex;align-items:center;gap:14px;">
                    <img src="{s['img']}" style="width:42px;height:42px;border-radius:50%;object-fit:cover;border:2px solid #2a2a2a;flex-shrink:0;">
                    <div style="flex:1;">
